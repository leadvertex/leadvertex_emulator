...
- Тулбар для отладки лендингов. Теперь если лендинг содерджит недопустимые имена файлов и каталогов, вы это увидите. Тулбар минимизируется двойным кликом
- Возможность легкого переключения между лендингами. Теперь в папке templates вы можете хранить хранить каждый лендинг отдельно
